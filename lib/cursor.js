...
// // Extend Core Cursor with Readable support
// inherits(CoreCursor, Readable);

// Flags allowed for cursor
var flags = ['tailable', 'oplogReplay', 'noCursorTimeout', 'awaitData', 'exhaust', 'partial'];

// Can we change the cursor
var isDead = function(self) {
...
class Cursor extends CoreCursor {
  ...
  // _read(n) {
  //   var self = this;
  //   if(self.state == 'closed' || self.isDead()) {
  //     return self.push(null);
  //   }

  //   // Get the next item
  //   self._next(function(err, result) {
  //     if(err) {
  ...
  //     // If we provided a transformation method
  //     if(typeof self.transform == 'function' && result != null) {
  //       return self.push(self.transform(result));
  //     }
